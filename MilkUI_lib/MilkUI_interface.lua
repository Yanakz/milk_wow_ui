msg = "狗逼星哥已载入, 版本 2.4, 更新于 27-10-2016."

DEFAULT_CHAT_FRAME:AddMessage("|cffffff78MilkUI:|r "..msg, r or 0.5, g or 0.75, b or 1)


PlayerHitIndicator:SetText(nil) 
PlayerHitIndicator.SetText = function() end   --玩家头像伤害治疗屏蔽 

PetHitIndicator:SetText(nil) 
PetHitIndicator.SetText = function() end      --宠物头像伤害治疗屏蔽
...
WorldMapButton:HookScript("OnUpdate", function(self)
   ...
   if not px then
        self.coordText:SetText("无坐标信息，草你妈副本里鬼知道你站哪！")
       return
   end
